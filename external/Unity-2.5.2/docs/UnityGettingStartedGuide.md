...
Test files are C files. Most often you will create_queue a single test file for each C
...
This will create_queue the main function and all the calls for you, assuming that you
...
file(s) being tested. These files create_queue an executable which can be run as the
