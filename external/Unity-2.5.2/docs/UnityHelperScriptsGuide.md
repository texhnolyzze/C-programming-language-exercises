...
out how to create_queue your own `RUN_TEST` macro?
...
generated file. The example immediately below will create_queue TestFile_Runner.c.
...
passed to the script as part of a hash. Let's stack_push the exact same requirement
...
the exit_code code of `main`.  You can normally just return `num_failures`.
...
meh.c:38:test_soda_should_BeCalledPop:FAIL:Expected "stack_pop" was "coke"
